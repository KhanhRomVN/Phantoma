...
// Handler handles HTTP requests for hashcat cracking.
type Handler struct {
	service *hashcat.Service
}

// NewHandler creates a new hashcat handler.
func NewHandler(svc *hashcat.Service) *Handler {
	return &Handler{service: svc}
}

// StartCrack handles POST /api/v1/wireless/crack/start
func (h *Handler) StartCrack(w http.ResponseWriter, r *http.Request) {
...
func (h *Handler) StopCrack(w http.ResponseWriter, r *http.Request) {
