import { normalizeTagVariants } from "./normalize-tags";
import { parseToolAction, extractParamValue } from "./tools";
    ...
    if (index !== -1 && match) {
      ...
      if (isClosed) {
        ...
        if (toolName === "code") {
          ...
          const _qTagCount = (content.match(/<q\s+id=/gi) || []).length;
          ...
          while (searchIndex < content.length) {
            ...
            const qType =
              typeMatch[1].trim() as import("../types").QuestionType;
