 ...
 * diffUtils
 * ------------------------------------------------------------------
 * Parse unified diff string thành code highlighted + stats.
 *
 * Main features:
 * - parseDiff()         : Parse unified diff text → code + highlights
 * - LineDiffHighlighter : Class highlight từng dòng thêm/xóa
 * ------------------------------------------------------------------
 */
