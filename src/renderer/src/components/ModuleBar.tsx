              ...
              <div key={item.id}>
                <button
                  ...
                  className={cn(
                    ...
                    isActive && !expanded && 'bg-[--module-color-bg]',
                  ...
                  style={
                    isActive
                      ? ({
                          ...
                          '--module-color-bg': moduleColor?.bg || 'rgba(54,134,255,0.1)',
                ...
                >
                  ...
                  {/* Active indicator bar - sát viền trái của ModuleBar khi collapse */}
                  {isActive && !expanded && (
                    <div
                      className="absolute left-0 top-1/2 -translate-y-1/2 w-[2px] rounded-r"
                      style={{
                        height: '50%',
                        backgroundColor: moduleColor?.base || $('--text-primary'),
                      }}
                    />
                  )}
                </button>
          ...
          <button
            ...
            className={cn(
              ...
              active === 'settings'
                ...
                : 'text-text-secondary hover:bg-sidebar-item-hover hover:text-text-primary',
              !expanded && 'border-l-2 border-solid',
              !expanded && (active === 'settings' ? 'border-primary' : 'border-transparent'),
            )}
          >
            <div
              className={cn(
