          ...
          <tbody>
            {payloads.length === 0 ? (
              <tr>
                ...
                >
                  No payloads yet. Use{' '}
                  <code className="bg-background px-1 rounded">{'${name}'}</code> in
                  Params/Headers/Body to auto-create payloads.
                </td>
              </tr>
            ) : (
                    ...
                    <td className="px-2 py-1.5 align-top">
                      <div className="flex items-center justify-center gap-1">
                        <button
                          ...
                          title={
                            payload.name ? `Go to \${${payload.name}} in request` : 'Name is empty'
                          }
                        >
