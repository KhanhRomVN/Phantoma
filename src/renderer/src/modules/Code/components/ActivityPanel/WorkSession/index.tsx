 ...
 * Work Session Panel
 * ------------------------------------------------------------------
 * Management panel for CLI work sessions.
 * Allows running multiple CLI terminals simultaneously (max 4 per session)
 * in split layouts.
 *
 * Main features:
 * - Create work sessions with multiple terminals (max 4)
 * - Choose layout: single, 2-split horizontal/vertical, 4-grid
 * - Configure terminal type and command per slot
 * - Quick launch work sessions
 * ------------------------------------------------------------------
 */
