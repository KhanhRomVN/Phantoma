...
export function FooterBar({ className }: FooterBarProps) {
  ...
  const handleExtensionsClick = () => {
    setActivityPanelTab('extensions');
  };
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 text-accent hover:text-accent/80 transition-colors cursor-pointer bg-transparent border-none p-0"
