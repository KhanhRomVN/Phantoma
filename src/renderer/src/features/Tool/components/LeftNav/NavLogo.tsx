export function NavLogo() {
  return (
    <div className="w-9 h-9 rounded-lg border border-cyan-800/50 bg-cyan-500/5 flex items-center justify-center mb-2 cursor-pointer shrink-0" title="PHANTOM v2.4.1">
