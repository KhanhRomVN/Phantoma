          ...
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3">
            ...
            {dns.SRV.map((srv, i) => (
              <div key={i} className="mb-2 pb-2 border-b border-[#111827] last:border-0">
                <div className="text-[12px] font-mono text-[#c8d6f0]">{srv.service}</div>
                <div className="flex gap-3 mt-1 text-[11px] font-mono text-[#c8d6f0]">
        ...
        <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3 col-span-2">
          ...
          <div className="space-y-1">
            {dns.TXT.map((txt, i) => (
              <div
                key={i}
                className="font-mono text-[10.5px] text-[#c8d6f0] bg-[#060810] border border-[#111827] rounded p-1.5 break-all"
              >
                "{txt}"
              </div>
            ))}
        ...
        <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3 col-span-2">
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              ...
              >
                <div className="text-[10px] uppercase tracking-wider text-[#c8d6f0] font-mono">
                  {item.k}
                </div>
                <div
