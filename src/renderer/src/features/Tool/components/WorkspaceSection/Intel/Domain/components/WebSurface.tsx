        ...
        {endpoints.length > 0 && (
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3">
            ...
            {endpoints.map((ep: string, i: number) => (
              <KV key={i} k={`Endpoint ${i + 1}`} v={ep} vc="text-[#c8d6f0]" />
            ))}
          ...
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3">
            ...
            <div className="flex flex-wrap gap-1">
              {hiddenDirs.map((dir: string, i: number) => (
                <span key={i} className="text-[10px] font-mono text-[#ff6b35] bg-[#ff6b3510] px-2 py-0.5 rounded border border-[#ff6b3530]">
                  {dir}
                </span>
              ))}
            </div>
        ...
        {jsFiles.length > 0 && (
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3">
            ...
            {jsFiles.map((file: string, i: number) => (
              <KV key={i} k={`JS[${i}]`} v={file} vc="text-[#c8d6f0]" />
            ))}
