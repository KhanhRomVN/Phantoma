            ...
            <table className="w-full text-[11px] font-mono">
              <thead>
                <tr className="border-b border-[#1c2333] bg-[#0a0e14]">
                  <th className="text-left p-2 text-[#c8d6f0] font-normal">Vulnerability</th>
                  <th className="text-left p-2 text-[#c8d6f0] font-normal">Severity</th>
                  <th className="text-left p-2 text-[#c8d6f0] font-normal">CVSS</th>
                  <th className="text-left p-2 text-[#c8d6f0] font-normal">Location</th>
                </tr>
              </thead>
              <tbody>
                {webVulnerabilities.length === 0 ? (
                  <tr>
                    <td
                      colSpan={4}
                      className="p-4 text-center text-[11px] font-mono text-[#c8d6f0]"
                    >
                  ...
                  webVulnerabilities.map((vuln, idx) => (
                    ...
                    >
                      <td className="p-2 font-mono text-[12px] text-[#ff6b35]">{vuln.name}</td>
                      <td className="p-2">
                      ...
                      <td className="p-2 text-[11px] text-[#0af]">{vuln.location}</td>
                    </tr>
                  ))
                )}
              </tbody>
