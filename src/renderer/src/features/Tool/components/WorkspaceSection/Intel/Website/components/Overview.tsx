      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="col-span-2 bg-gradient-to-r from-[#0a0e14] to-[#0d1017] border border-[#1c2333] rounded p-3 mb-1">
          <div className="flex justify-between items-center">
            <div>
              ...
              <div className="text-[10px] font-mono text-[#c8d6f0] mt-0.5">{technologyDetection.webServer.join(', ')} • {technologyDetection.cdn.join(', ')}</div>
            </div>
        ...
        <div className="grid grid-cols-4 gap-2 col-span-2 mb-1">
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">Endpoints</div>
            <div className="text-[19px] font-bold text-[#0af]">{endpointCount}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">Hidden Paths</div>
            <div className="text-[19px] font-bold text-[#ff6b35]">{hiddenCount}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">Vulnerabilities</div>
            <div className="text-[19px] font-bold text-[#ff2d55]">{vulnCount}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">MFA</div>
            <div className={`text-[19px] font-bold ${mfaEnabled ? 'text-[#30d158]' : 'text-[#ff2d55]'}`}>{mfaEnabled ? '✓' : '✗'}</div>
          </div>
        </div>
