      ...
      <div className="grid grid-cols-2 gap-2">
            ...
            <table className="w-full text-[11px] font-mono">
              <thead>
                <tr className="border-b border-[#1c2333] bg-[#0a0e14]">
                  <th className="text-left p-2 text-[#c8d6f0] font-normal tracking-wider">Service</th>
                  <th className="text-left p-2 text-[#c8d6f0] font-normal tracking-wider">Default Port</th>
                  <th className="text-left p-2 text-[#c8d6f0] font-normal tracking-wider">Status</th>
                  <th className="text-left p-2 text-[#c8d6f0] font-normal tracking-wider">Risk Level</th>
                  <th className="text-left p-2 text-[#c8d6f0] font-normal tracking-wider">Recommendation</th>
                </tr>
              </thead>
              <tbody>
                {exposures.map((exp, idx) => (
                  <tr key={idx} className="border-b border-[#111827] hover:bg-[#111827] transition-colors">
                    <td className="p-2 font-mono text-[12px] text-[#0af]">{exp.name}</td>
                    <td className="p-2 text-[11px] text-[#c8d6f0]">{exp.port}/tcp</td>
                    <td className="p-2">
                    ...
                    <td className="p-2">
                      {exp.exposed && (
                        <span className="text-[9px] font-bold font-mono uppercase px-1.5 py-0.5 rounded-sm" style={{ 
                    ...
                    <td className="p-2 text-[11px] text-[#c8d6f0]">
        ...
        {exposedCount > 0 && (
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3 col-span-2">
            ...
            <div className="text-[11px] font-mono text-[#ff6b35]">
