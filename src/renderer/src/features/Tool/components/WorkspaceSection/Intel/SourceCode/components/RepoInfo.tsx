      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3">
          ...
          {repoInfo.commitHistory ? (
            ...
            <span className="text-[11px] text-[#c8d6f0]">No commit data</span>
          )}
        </div>
            ...
            <table className="w-full text-[11px] font-mono">
              <thead>
                <tr className="border-b border-[#1c2333]">
                  <th className="text-left p-1 text-[#c8d6f0] font-normal">Name</th>
                  <th className="text-left p-1 text-[#c8d6f0] font-normal">Email</th>
                  <th className="text-left p-1 text-[#c8d6f0] font-normal">Commits</th>
                </tr>
              </thead>
              <tbody>
                {developerInfo.contributors?.map((contributor, idx) => (
                  <tr key={idx} className="border-b border-[#111827]">
                    ...
                    <td className="p-1 text-[#c8d6f0]">{contributor.email}</td>
