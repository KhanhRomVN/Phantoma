      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="col-span-2 bg-gradient-to-r from-[#0a0e14] to-[#0d1017] border border-[#1c2333] rounded p-3 mb-1">
          <div className="flex justify-between items-center">
            <div>
              ...
              <div className="text-[10px] font-mono text-[#c8d6f0] mt-0.5">{networkInfo.reverseDns || 'No PTR record'}</div>
            </div>
        ...
        <div className="grid grid-cols-4 gap-2 col-span-2 mb-1">
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">Open Ports</div>
            <div className="text-[19px] font-bold text-[#30d158]">{openPorts}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">Filtered</div>
            <div className="text-[19px] font-bold text-[#f5a623]">{filteredPorts}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">Vulnerabilities</div>
            <div className="text-[19px] font-bold text-[#ff2d55]">{securityFindings.length}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[10px] text-[#c8d6f0]">Exposures</div>
            <div className="text-[19px] font-bold text-[#ff6b35]">{exposures}</div>
          </div>
        </div>
