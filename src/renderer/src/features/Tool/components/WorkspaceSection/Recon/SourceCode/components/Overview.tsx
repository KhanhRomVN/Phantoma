      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="col-span-2 bg-gradient-to-r from-[#0a0e14] to-[#0d1017] border border-[#1c2333] rounded p-3 mb-1">
          <div className="flex justify-between items-center">
            <div>
              ...
              <div className="text-[9px] font-mono text-[#3a4558] mt-0.5">{repoInfo.owner} • {repoInfo.visibility}</div>
            </div>
        ...
        <div className="grid grid-cols-4 gap-2 col-span-2 mb-1">
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[9px] text-[#3a4558]">Commits</div>
            <div className="text-[18px] font-bold text-[#0af]">{commitCount.toLocaleString()}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[9px] text-[#3a4558]">Contributors</div>
            <div className="text-[18px] font-bold text-[#30d158]">{contributorCount}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[9px] text-[#3a4558]">Secrets Exposed</div>
            <div className="text-[18px] font-bold text-[#ff2d55]">{secretCount}</div>
          </div>
          <div className="bg-[#0d1017] border border-[#1c2333] rounded p-2 text-center">
            <div className="text-[9px] text-[#3a4558]">Vuln. Dependencies</div>
            <div className="text-[18px] font-bold text-[#ff6b35]">{vulnerableDeps}</div>
          </div>
        </div>
