        ...
        {showAddForm && (
          <div className="p-2 border-b border-[#1c2333] shrink-0 space-y-1.5">
            ...
            <div className="flex gap-1">
              {(['name', 'email', 'username'] as const).map((qt) => {
                ...
                return (
                  <button
                    ...
                    className="flex-1 h-6 rounded text-[9px] font-mono font-bold transition-all"
                    style={{
              ...
              <button
                onClick={addPerson}
                className="h-6 w-6 rounded text-[11px] font-bold font-mono transition-colors"
              ...
              >
                ...
                <div className="pl-2">
                  ...
                  <div className="flex items-center justify-between mb-0.5">
                    <span
                      className="text-[8px] font-mono font-bold px-1 py-0.5 rounded tracking-widest"
                  ...
                  <div className="absolute right-0 top-8 z-50 w-52 bg-[#0d1017] border border-[#1c2333] rounded shadow-lg py-1">
                    {SUB_TABS.map((tab) => (
                      <button
                        ...
                        className={cn(
                          'w-full flex items-center gap-2 px-3 py-1.5 text-[11px] font-mono transition-colors',
