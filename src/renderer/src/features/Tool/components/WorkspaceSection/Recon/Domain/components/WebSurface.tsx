  ...
  return (
    <div className="flex-1 overflow-y-auto p-3 bg-[#080b10]">
      <div className="bg-[#0d1017] border border-[#1c2333] rounded p-3">
        <SectionHeader accent="#0af">Web Surface Discovery</SectionHeader>
        <div className="text-[11px] text-[#6a7a9a]">TBD: Websites, login pages, admin panels, API endpoints</div>
      </div>
    </div>
  );
}