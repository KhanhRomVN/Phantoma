...
export const TargetPanel: React.FC<TargetPanelProps> = ({
  ...
  const [editingApp, setEditingApp] = useState<{ id: string; name: string; url?: string; executablePath?: string } | null>(null);
            ...
            return (
              ...
              >
                ...
                <div className="border-t border-[#1e2535] mt-1 pt-1">
                  <button
                    onClick={() => {
                      setEditingApp({ id: app.id, name: app.name, url: app.url, executablePath: app.executablePath });
