...
import { Whois } from './components/Domain/Whois';
import { DnsRecords } from './components/Domain/DnsRecords';
import { Subdomains } from './components/Domain/Subdomains';
import { SslTlsCerts } from './components/Domain/SslTlsCerts';
import { Infrastructure } from './components/Domain/Infrastructure';
import { SensitiveExposure } from './components/Domain/SensitiveExposure';
import { TechStack } from './components/Domain/TechStack';
import { Osint } from './components/Domain/Osint';
import { Emails } from './components/Domain/Emails';
import { Mentions } from './components/Domain/Mentions';
import { Network } from './components/Domain/Network';
import { People } from './components/Domain/People';
import { Log } from './components/Domain/Log';
  ...
  const renderContent = () => {
    ...
    if (showLog && result) {
      return (
        <Log
          ref={logRef}
          data={result as unknown as import('./types/domain/recon-data').ReconData}
            ...
            dataPoints={
              selectedEntity
                ? selectedEntity.dataPoints.filter(
                    (dp: { isNoise: any; category: string }) =>
                      dp.isNoise || dp.category === 'unclassified',
                  )
