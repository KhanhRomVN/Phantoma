import type { ReconResult } from '../../types/person/recon-result';
...
export function Overview({ result, onSelectEntity }: OverviewProps) {
  ...
  const socialCount = result.allDataPoints.filter((dp) => dp.category.startsWith('social_')).length;
  const leakCount = result.allDataPoints.filter((dp) => dp.category.startsWith('leak_')).length;
    ...
    <div className="flex-1 overflow-y-auto p-3">
      ...
      <div className="grid grid-cols-4 gap-2 mb-3">
        ...
        <StatBox
          ...
          value={leakCount}
          sub="exposures"
          accent={leakCount > 0 ? '#ff2d55' : '#30d158'}
        />
      </div>
