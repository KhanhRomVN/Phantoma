...
├── index.tsx                    ← Tab container (chuyển đổi 4 target)
...
### 🎯 4 Mục Tiêu Tình Báo (Passive)

| # | Target | Nhóm dữ liệu | Mô tả |
|---|--------|-------------|-------|
| 1 | **Domain** | 7 | Danh tính, DNS, Subdomain (thụ động), Công nghệ, Lộ thông tin, OSINT & Breach, Lịch sử web |
| 2 | **Person** | 5 | Danh tính, Liên hệ, Mạng xã hội, Dấu chân kỹ thuật, Rò rỉ cá nhân |
| 3 | **Source Code** | 4 | Repository public, Developer info, Secret exposure, Dependency |
| 4 | **IP** | 3 | GeoIP, ASN, Reverse DNS, Shodan tổng quan (không quét) |
...
### 5.2 Shodan / Censys Intelligence
