...
<markdown>2/3 file đã sửa thành công (math.ts, utils.ts). File format.ts thất bại vì nội dung old_content không khớp — có thể file đã thay đổi. Đang đọc lại format.ts để sửa riêng.</markdown>
