...
✅ **Lý do**: Gộp 5 OSINT nhỏ lẻ thành 1 module nhưng vẫn giữ đủ feature; thêm Recon để tách bạch quét chủ động khỏi OSINT thụ động.
...
#### 6. **Web Injection** (gộp Sqli + XSS + các injection khác)
...
#### 15. **Forensics** (tách riêng khỏi malware)
...
#### 16. **Phishing** (module mới, thiếu trong danh sách trước)
